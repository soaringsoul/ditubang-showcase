    ...
    <div className="relative w-full h-full bg-[var(--bg-primary)] overflow-hidden flex flex-col">
      ...
      <div className="relative px-6 md:px-10 pt-5 pb-2">
        <div className="flex items-center gap-3 mb-2">
          ...
          <span className="text-sm font-medium text-[var(--text-tertiary)]">07 / 07</span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className="space-y-4">
            <div className="p-5 rounded-2xl bg-[var(--black)] text-white">
              <h3 className="font-bold text-base mb-4">第一次接触地图帮，建议这样开始</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-xl bg-emerald-50 border border-emerald-200">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h4 className="font-bold text-sm text-[var(--text-primary)]">免费体验</h4>
              </div>
              ...
              <div className="mt-2 flex items-center gap-2">
                ...
                <span className="text-xs font-medium text-[var(--banana-yellow-dark)]">
